    ...
    public partial class InitialMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVideoStatus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserVideoStatus_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserVideoStatus_Videos_VideoId",
                        column: x => x.VideoId,
                        principalSchema: "Konet",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVideoStatus_UserId_VideoId_Status",
                schema: "Konet",
                table: "UserVideoStatus",
                columns: new[] { "UserId", "VideoId", "Status" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserVideoStatus_VideoId",
                schema: "Konet",
                table: "UserVideoStatus",
                column: "VideoId");
