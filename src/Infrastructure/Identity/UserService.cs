...
using Konet.Application.Common.Caching;
...
using Konet.Application.Common.Mailing;
using Konet.Application.Common.Models;
using Konet.Application.Common.Specification;
...
namespace Konet.Infrastructure.Identity;
internal partial class UserService : IUserService
{
    ...
    public async Task<List<UserDetailsDto>> GetListAsync(List<string> userId, CancellationToken cancellationToken)
    {
        return (await _userManager.Users.Where(u => userId.Contains(u.Id)).ToListAsync(cancellationToken)).Adapt<List<UserDetailsDto>>() ?? new List<UserDetailsDto>();
    }
}