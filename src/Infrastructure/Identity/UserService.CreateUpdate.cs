...
internal partial class UserService
{
    ...
    public async Task UpdateAsync(UpdateUserRequest request, string userId)
    {
        ...
        if (request.DeleteCurrentImage && user.ImagePublicId is not null)
        {
            await _fileStorage.DeleteAsync(user.ImagePublicId, ResourceType.Image);
        }
        ...
        if (request.Image is not null)
        {
            ...
            UploadResult uploadImg = await _fileStorage.UploadAsync(request.Image!);

            user.ImageUrl = uploadImg.Url.ToString();
            user.ImagePublicId = uploadImg.PublicId;
        }
