...
namespace Konet.Shared.Authorization;
...
public static class FSHPermissions
{
    private static readonly FSHPermission[] _all = new FSHPermission[]
    {
        ...
        new("Create Video", FSHAction.Create, FSHResource.Video),
        new("Update Video", FSHAction.Update, FSHResource.Video),
        new("Delete Video", FSHAction.Delete, FSHResource.Video),
    };
